                  ...
                  {activeTab === "monthly" ? (
                    <div>
                      <div className="flex items-baseline gap-2">
                        {plan.id === "enterprise" && <span className="text-xl font-bold text-white/60">{t('plans_from')}</span>}
                        <span className="text-5xl font-black text-white">{plan.monthly.split(" ")[0]}</span>
                        <span className="text-white/60 font-medium">{t('plans_per_month')}</span>
                      </div>
                      <p className="text-white/50 text-xs mt-1">+ {plan.id === "enterprise" ? `${t('plans_from').toLowerCase()} ` : ""}{plan.implementation} {t('plans_impl_prefix')}</p>
                      {plan.id === "enterprise" && (
                        <p className="text-white/40 text-xs mt-0.5 italic">{t('plans_scope_note')}</p>
                      )}
                    </div>
                  ) : (
                    <div>
                      ...
                      <p className="text-white/50 text-xs">{t('plans_monthly_then')} {plan.id === "enterprise" ? `${t('plans_from').toLowerCase()} ` : ""}{plan.monthly}</p>
                      {plan.id === "enterprise" && (
                        <p className="text-white/40 text-xs mt-0.5 italic">{t('plans_scope_note')}</p>
                      )}
                    </div>
