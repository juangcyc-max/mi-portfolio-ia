  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center px-6 py-20">
      ...
      <div className="w-full max-w-lg space-y-4">
        ...
        {/* iOS */}
        <div className="bg-slate-800/60 border border-slate-700 rounded-2xl px-6 py-5 w-full">
          <div className="flex items-center gap-3 mb-4">
            <svg className="w-8 h-8 text-slate-400 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
            ...
            <p className="font-bold text-white text-lg">iPhone / iPad</p>
          </div>

          <ol className="space-y-3">
            {[
              <>Abre <strong className="text-white">Safari</strong> (no Chrome ni otro navegador)</>,
              <>Ve a <strong className="text-emerald-400">mindbride.net</strong></>,
              <>Pulsa el botón de compartir <span className="inline-flex items-center gap-1 bg-slate-700 rounded px-2 py-0.5 text-xs text-white align-middle">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/></svg>
                  Compartir
                </span> en la barra inferior de Safari</>,
              <>Desplázate y toca <strong className="text-white">Añadir a pantalla de inicio</strong></>,
              <>Pulsa <strong className="text-white">Añadir</strong> — ya aparecerá como una app</>,
            ].map((step, i) => (
