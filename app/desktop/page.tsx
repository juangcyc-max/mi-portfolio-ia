...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Volumen, fondo de pantalla, apps, capturas — todo con lenguaje natural.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    desc: 'Crea imágenes profesionales con DALL·E desde la misma app.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    desc: 'Define tareas que se ejecutan solas: limpieza, actualizaciones, seguridad.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    ...
    desc: 'Vive en la barra de tareas. Un clic y tienes tu asistente listo.',
  },
]
    ...
    <main className="min-h-screen bg-slate-100 text-slate-900 relative overflow-hidden">
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-8 pt-24 pb-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href={DOWNLOAD_URL}
            className="flex items-center gap-3 px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-white font-bold rounded-2xl transition-colors text-lg shadow-lg shadow-emerald-500/20"
          >
