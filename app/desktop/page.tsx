...
export default function DesktopPage() {
  return (
    <main className="min-h-screen bg-slate-100 text-slate-900 relative overflow-hidden">
      ...
      <nav className="relative z-10 sticky top-0 flex items-center justify-between px-8 py-5 border-b border-slate-200 bg-white/80 backdrop-blur-sm max-w-6xl mx-auto">
        <Link href="/"><Image src="/logo.svg" alt="Mindbridge IA" width={140} height={32} /></Link>
